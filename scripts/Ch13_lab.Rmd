...
flights %>%
  ...
  summarise(combos = n_distinct(tailnum, carrier)) %>% #this is the problem.  n_distinct is essentially counting the same thing that was grouped by in the line above.  therefor it wil always be 1
  filter(combos > 1)
